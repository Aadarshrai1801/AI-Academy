...
const VARIANT_META: Record<ToastVariant, { icon: typeof Info; className: string; bar: string }> = {
  info: { icon: Info, className: "text-state-info-ink", bar: "bg-state-info" },
  success: { icon: CircleCheck, className: "text-state-positive-ink", bar: "bg-state-positive" },
  error: { icon: XCircle, className: "text-state-negative-ink", bar: "bg-state-negative" },
  warning: { icon: TriangleAlert, className: "text-state-warning-ink", bar: "bg-state-warning" },
  brand: { icon: Info, className: "text-brand-ink", bar: "bg-brand" },
};
